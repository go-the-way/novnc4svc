...
export default class RFB extends EventTargetMixin {
    constructor(target, url, options) {
        ...
        this._url = url;
        this.retry = 8;
        this.retry_task = options.retry_task
    ...
    this._cursor = new Cursor();
        ...
        this._sock.on('open', () => {
            if ((this._rfb_connection_state === 'connecting') &&
                ...
                if(this._fb_name){
                    document.getElementById('status').textContent = 'Connected to ' + this._fb_name;
                    clearInterval(this.retry_task)
                }
            } else {
        ...
        this._sock.on('close', (e) => {
            ...
            if(this._rfb_connection_state == 'connecting' && this.retry > 0){
    ...
    sendCtrlV(){
        //this.sendKey(KeyTable.XK_Control_L, "ControlLeft", true);
        // this.sendKey(KeyTable.XK_Shift_R, "ShiftRight", true);
        // this.sendKey(KeyTable.XK_Insert, "Insert", true);
        // this.sendKey(KeyTable.XK_Insert, "Insert", false);
        // this.sendKey(KeyTable.XK_Shift_R, "ShiftRight", false);
        this.sendKey(KeyTable.XF86XK_Paste, "PASTE");
        //this.sendKey(KeyTable.XK_Control_L, "ControlLeft", false);
    }
    ...
    _sendEncodings() {
        ...
        encs.push(encodings.pseudoEncodingQualityLevel0 + 0); // 默认6
        encs.push(encodings.pseudoEncodingCompressLevel0 + 9);  // 默认2
